  ...
  return (
    <section className="bg-white py-5 sm:py-10 lg:py-12">
      <div className="relative w-full overflow-hidden bg-black">
        ...
        <div className="relative rounded-[2rem] bg-[#006AEF] px-4 pb-16 pt-8 text-[#F6ECD9] sm:px-6 sm:pb-20 sm:pt-10 md:rounded-[2.35rem] md:pb-24 md:pt-10 lg:px-8 lg:pb-28 lg:pt-10">
          <div className="mx-auto w-full max-w-6xl">
            <h2 className="max-w-5xl text-[clamp(2.7rem,7vw,5.8rem)] leading-[0.92] tracking-[-0.04em] font-normal">
              El{" "}
              <span className="inline-flex rounded-full bg-[#F4EEDF] px-4 py-1 text-[#006aef] font-normal">
                amor
              </span>{" "}
        ...
        <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 pb-8 pt-2 sm:px-6 sm:gap-12 sm:pb-10 sm:pt-4 md:grid-cols-[minmax(0,30rem)_1fr] md:items-center md:gap-12 md:pb-12 md:pt-6 lg:px-8 lg:gap-14 lg:pb-14 lg:pt-8">
          <div className="relative aspect-[1/1.02] overflow-hidden rounded-[2rem] bg-[#e9e0d1] md:-mt-20 lg:-mt-24">
            <Image
          ...
          <div className="max-w-2xl pb-2 text-[#F6ECD9] md:pt-4">
